...
--
-- Generation Time: Dec 26, 2019 at 10:53 PM
...
(
    attendee_id   INTEGER PRIMARY KEY AUTO_INCREMENT,
...
(
    ticket_price_id       INTEGER PRIMARY KEY AUTO_INCREMENT,
...
(
    discount_code_id INTEGER PRIMARY KEY AUTO_INCREMENT,
...
(
    attendee_ticket_id INTEGER PRIMARY KEY AUTO_INCREMENT,
...
(
    time_slot_id         INTEGER PRIMARY KEY AUTO_INCREMENT,
